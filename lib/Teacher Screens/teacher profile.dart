...
class _teacher_ProfileState extends State<teacher_Profile> {
  ...
  void _loadFromStorage() {
    try {
      ...
      if (storedTeacherMap != null) {
        final fullName =
            ((storedTeacherMap['firstName'] ?? '') +
                    ' ' +
                    (storedTeacherMap['lastName'] ?? ''))
                .trim();
        ...
        officeController.text =
            storedTeacherMap['officeLocation']?.toString() ?? '';
        departmentController.text =
            storedTeacherMap['department']?.toString() ?? '';
        specializationController.text =
            storedTeacherMap['specialization']?.toString() ?? '';
        qualificationController.text =
            storedTeacherMap['qualification']?.toString() ?? '';
        experienceController.text =
            storedTeacherMap['experience']?.toString() ?? '';
  ...
  Future<void> saveChanges() async {
    ...
    final Map<String, dynamic> payload = {
      ...
      if (qualificationController.text.trim().isNotEmpty)
